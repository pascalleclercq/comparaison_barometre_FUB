...
# gdf_communes = gdf_communes_shp.join(
#     gdf_2025.set_index("insee").loc[:, ("contributions_2025","population", "coords", "per_cent")], on="insee", how="outer"
# )
...
at_least_one = gdf_dep[(gdf_dep["contributions_2021"] > 0)]
...
pl.savefig(f"png/{epci.id}/taux_2021.png", dpi=300)
